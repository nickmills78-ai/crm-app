# Nick Mills — About Me (Work Profile)

**Purpose:** Detailed working profile for AI agents and project handoffs. Trim per project; this file is the long-form source of truth.

**Related:** Email drafting voice lives in [`docs/email-voice-profile.md`](email-voice-profile.md). Use that file for *how* to write email; use this file for *who Nick is*, how he works, and what agents may/may not do.

**Do not include in this file:** salary/compensation, personal politics, or unrelated personal life detail.
...
**Standard email signature** (from email voice profile):
...
10905 Technology Place Suite B San Diego CA 92127
...
## 2. Role in plain language

**One-liner:** Sourcing and managing supply chain for B2B clients.
...
| Person / role | What they typically own | What Nick typically owns |
|---|---|---|
...
Respect for the other person’s position comes first. Tone then adjusts situation by situation (customer vs vendor vs internal; routine vs fire drill). Warm and professional by default; firmer when vendors are silent or blocking a customer commitment. Full email patterns: see email voice profile.

---

## 4. Strengths & knowledge depth

### Primary strengths (lean on these)
...
### Secondary (competent; not the main brand)

- Specs / technical packaging  
- Quoting / RFQs  
- Logistics  
- Quality / compliance  
...
1. **Problem solving** — unblock the real issue, not just reply  
...
**Quality first.** Protect quality ahead of speed or convenience when tradeoffs appear. Margin and on-time matter, but not by shipping the wrong or risky thing.
...
1. **Inquiry** — customer need / opportunity  
2. **Quote** — source, specify, RFQ vendors, present commercially  
3. **PO** — order placement (often operationalized with Katia)  
4. **Production** — vendor execution, ETA and quality vigilance  
5. **Delivery** — confirm fulfillment; protect customer experience  

Agents helping on a live job should state which stage the work is in and what the next concrete step is.
...
## 9. Language agents should use fluently

Use these as first-class concepts in summaries, CRM notes, and options:
...
Tie recommendations to these where relevant (e.g. “faster freight improves on-time but hurts landed cost / margin”).

---

## 10. Common fire drills (in-pattern problems)

Nick regularly deals with:

- Missed ETAs  
- Quality rejects  
- Wrong specs  
- Price creep  
- Silent / unresponsive vendors  
- Last-minute quantity changes  

Also drains time/energy:

- Slow vendors  
- Rude counterparts  
- Too many meetings to make simple decisions  

**How agents should help in fire drills:** short status → risk → options with a recommendation → clear ask / next step. Avoid meeting-shaped process when a decision can be made in writing.

---

## 11. How Nick wants information presented

**Default stack:**

1. **Bottom line first**  
2. **Short bullets** for actions, risks, status  
3. **Tables** for comparisons (vendors, prices, ETAs, options)  
4. **Full narrative** only when the situation needs story/context  
...
- Flag risks early  
- Keep it short  
- Bring options **with a recommendation** (not an open-ended dump)
...
## 13. AI / agent rules (hard)

### High-value assistance (do this)

- Draft email (for Nick to review)  
- Organize CRM notes  
- Research suppliers  
- Prep RFQs  
- Summarize threads  
...
| Never | Why |
|---|---|
| **Send emails (or other external messages) without Nick’s approval** | Nick reviews **all** emails before anything goes out |
| Blame a vendor to a customer | Damages trust / unprofessional |
| Commit price or date | Commercial commitment — human only |
| Apologize for the company | Wording and ownership are Nick’s call |
| Use slang | Wrong voice |
| Invent pricing, legal commitments, or engineering conclusions | Out of scope / risk |

### Soft rules

- English only for Nick’s email (see email voice profile)  
- Match respect-first tone; adjust firmness by situation  
...
## 15. Do / don’t cheat sheet (for agents)

### Do

- Call him Nick  
- Lead with the answer, then bullets/tables  
- Recommend a path, don’t only list options  
...
## 16. How to use this file on a project

1. Read this file for role, priorities, and hard limits.  
2. Read [`email-voice-profile.md`](email-voice-profile.md) before drafting email.  
3. Trim: copy only the sections relevant to the project (e.g. AI rules + fire drills + metrics) into a shorter project brief if needed.  
4. When unsure about a commercial or external commitment: **ask Nick**; do not guess.
...
## 18. Interview source log

| Round | Topics captured |
|---|---|
| 1 | Name, title, job one-liner, audiences, San Diego, career path, success criteria |
